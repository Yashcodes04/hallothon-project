...
var quiz = {
    "JS": [
        {
            "id": 1,
            "question": "The Laplace Transform of e^(at)*sint(bt):",
            "options": [
                {
                    "a": "b/((s-a)^2 + b^2)",
                    "b": "a/((s-a)^2 + b^2)",
        ...
        {
            "id": 2,
            "question": "The Laplace Transforms of u(t):",
            "options": [
                {
                    "a": "1/2s",
                    "b": "1/s",
        ...
        {
            "id": 3,
            "question": "If A = {1,3,5,6,7} and B = {7,8,9} , find A - B :",
            "options": [
                {
                    "a": "{1,3,5}",
                    "b": "{1,3,5,4,6}",
        ...
        {
            "id": 4,
            "question": "What is the probability of getting atleast 1 head when 2 coins are tossed ?",
            "options": [
                {
                    "a": "3/4",
                    "b": "3/2"
        ...
        {
            "id": 5,
            "question": "Find the inverse laplace transform of (s+2)/((s+2)^2 + 4):",
            "options": [
                {
                    "a": "e^(-2t)*cos(2)t",
                    "b": "e^(-2t)*sin(2)t",
        ...
        {
            "id": 6,
            "question": "Find the inverse laplace transform of (s)/(s^2 - 4)",
            "options": [
                {
                    "a": "cosht",
                    "b": "sinht",
